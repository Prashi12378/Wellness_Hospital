    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-black text-slate-900 tracking-tight uppercase">Laboratory Worklist</h1>
                ...
                <div className="flex gap-3">
                    ...
                    <button className="flex items-center gap-2 bg-slate-900 text-white px-6 py-3 rounded-2xl font-black text-sm shadow-xl hover:scale-[1.02] active:scale-[0.98] transition-all uppercase tracking-wider">
                                ...
                                <tr key={req.id} className="hover:bg-slate-50/30 transition-colors group">
                                    ...
                                    <td className="px-8 py-6 text-right">
                                        <div className="flex items-center justify-end gap-2">
                                            <button className="p-3 bg-slate-50 text-slate-400 hover:text-primary hover:bg-white hover:shadow-md hover:border-primary/20 border border-transparent rounded-2xl transition-all group-hover:scale-105">
                                                <FlaskConical className="w-5 h-5" />
                                            </button>
                                            <button className="p-3 bg-slate-50 text-slate-400 hover:text-emerald-500 hover:bg-white hover:shadow-md hover:border-emerald-200 border border-transparent rounded-2xl transition-all group-hover:scale-105">
